...
def sum_mul():
    ...
    # go through accepted lines and do the same as `day_3_part_1.py`
    for do_line in do_lines:
        ...
        for mul in muls:
            ...
            sum_mul_result = sum_mul_result + multiple
    return sum_mul_result


sum_mul_result = sum_mul()
print(sum_mul_result)
assert sum_mul_result == 89349241
print("done")
